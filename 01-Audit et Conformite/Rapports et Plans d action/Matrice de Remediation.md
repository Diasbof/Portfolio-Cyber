...
| :--- | :--- | :--- |
| WIN-479952UTUH2 (DC01) | Contrôleur de domaine | GPO ciblant l'OU "Serveurs" ou "Domain Controllers" |
| Postes Clients / Serveurs Membres | Ensemble du domaine | GPO ciblant les OU spécifiques ("Postes Clients", "Utilisateurs") |
...
| **REM-05** | Politique de mots de passe globale insuffisante  | Moyenne              | Modification de la "Default Domain Policy" (Longueur minimale : 14 caractères).               | GPO         | ⏳ À faire  |
